var capacitorFaceDetection = (function (exports, core) {
    'use strict';
    ...
    })(exports.PerformanceMode || (exports.PerformanceMode = {}));
    /**
    ...
    })(exports.LandmarkMode || (exports.LandmarkMode = {}));
    /**
    ...
    })(exports.ContourMode || (exports.ContourMode = {}));
    /**
     ...
     */
    exports.ClassificationMode = void 0;
    ...
    })(exports.ClassificationMode || (exports.ClassificationMode = {}));
    /**
    ...
    })(exports.LandmarkType || (exports.LandmarkType = {}));
    /**
    ...
    })(exports.ContourType || (exports.ContourType = {}));

    const FaceDetection = core.registerPlugin('FaceDetection', {
        web: () => Promise.resolve().then(function () { return web; }).then(m => new m.FaceDetectionWeb()),
    });

    class FaceDetectionWeb extends core.WebPlugin {
        async processImage(_options) {
            throw this.createUnavailableException();
        }
        createUnavailableException() {
            return new core.CapacitorException('This Face Detection plugin method is not available on this platform.', core.ExceptionCode.Unavailable);
        }
    }

    var web = /*#__PURE__*/Object.freeze({
        __proto__: null,
        FaceDetectionWeb: FaceDetectionWeb
    });
